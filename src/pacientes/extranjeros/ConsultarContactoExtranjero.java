 ...
 * @author PC
 */
public class ConsultarContactoExtranjero extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarContactoNacional
     */
    public ConsultarContactoExtranjero() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarContactoExtranjero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarContactoExtranjero().setVisible(true);
            }
        });
    }
