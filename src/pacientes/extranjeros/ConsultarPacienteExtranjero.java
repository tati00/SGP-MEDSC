 ...
 * @author PC
 */
public class ConsultarPacienteExtranjero extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarPaciente
     */
    public ConsultarPacienteExtranjero() {
        initComponents();
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        PacienteExtranjero pex = new PacienteExtranjero();
        pex.getClass();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarPacienteExtranjero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarPacienteExtranjero().setVisible(true);
            }
        });
    }
